  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
          ...
          <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Create imaginative and visually stunning images generated through DALL-E AI and share it</p>
        </div>
      ...
      <div className='mt-5 flex gap-5'>
        ...
        className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">
          {generateImage ? 'Generatin...' : 'generate'}
        </button>
      </div>
      <div className='mt-10'>
